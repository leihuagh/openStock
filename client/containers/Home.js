      ...
      <div className="container-fluid">
          ...
          <div className="row">
            ...
            <div className="col card-stock">
              {this.state.stocksFetched ? <CardGraph name='NDAQ' d={NDAQ.chart} companyName="Nasdaq Inc." latestPrice={NDAQ.quote.latestPrice} changePercent={NDAQ.quote.changePercent} volume={NDAQ.quote.latestVolume} width="250" height="75"/> : <Spinner/> }
            </div>
            <div className="col card-stock">
              {this.state.stocksFetched ? <CardGraph name='SPY' d={SPY.chart} companyName="S&P 500" latestPrice={SPY.quote.latestPrice} changePercent={SPY.quote.changePercent} volume={SPY.quote.latestVolume} width="250" height="75"/> : <Spinner/> }
            </div>
            <div className="col card-stock">
              {this.state.stocksFetched ? <CardGraph name='DIA' d={DIA.chart} companyName="Dow Jones" latestPrice={DIA.quote.latestPrice } changePercent={DIA.quote.changePercent} volume={DIA.quote.latestVolume} width="250" height="75"/> : <Spinner/> }
            </div>
            <div className="col"></div>
            <div className="col"></div>
          </div>
